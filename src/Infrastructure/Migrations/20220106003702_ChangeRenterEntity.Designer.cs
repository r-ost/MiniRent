...
namespace CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20220106003702_ChangeRenterEntity")]
    partial class ChangeRenterEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniRent.Domain.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniRent.Domain.Entities.Car", b =>
                {
                    ...
                    b.OwnsOne("MiniRent.Domain.ValueObjects.CarModel", "CarModel", b1 =>
                        {
            ...
            modelBuilder.Entity("MiniRent.Domain.Entities.Rent", b =>
                {
                    b.HasOne("MiniRent.Domain.Entities.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
